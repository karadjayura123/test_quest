...
<div class="container">
    ...
    <div class="mb-3">
        ...
        <a href="/surveys/sort/status?sort=status&value=1">Статусу</a> |
        <a href="/surveys/sort/date_create?sort=date_create&value=2">Дате создания</a> |
        <a href="/surveys/sort/title?sort=title&value=3">Заголовку</a>
    </div>
    ...
    <?php foreach ($surveys as $survey) : ?>
        <div class="card mt-3">
            <div class="card-body">
                ...
                <?php endif; ?>
                <div class="mt-3">
                    <a href="/survey/delete/<?= $survey['id'] ?>" class="btn btn-danger">Удалить</a>
                    <a href="/survey/edit/<?php echo $survey['id']; ?>"class="btn btn-primary">Редактировать</a>
...
<script>
    document.getElementById('generateTokenBtn').addEventListener('click', function() {
        // AJAX-запрос для получения токена
        ...
        xhr.onload = function() {
            if (xhr.status === 200) {
                ...
                document.getElementById('tokenContainer').innerHTML = 'Token: ' + token;
            }
        };
